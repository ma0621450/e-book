...
const AuthorPostCard = ({ content, onPublish }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post("/api/get-user-ids", {
                emails: emailArray,
            });
            ...
            const accessResponse = await axios.post("/api/grant-access", {
                userIds: data.userIds,
                contentId: content.id,
            });

            if (accessResponse.data.errors) {
                setError(accessResponse.data.errors.join(", "));
                return;
            }
